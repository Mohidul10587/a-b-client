...
const IndexPage: React.FC = () => {
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      const response = await fetchWithTokenRefresh(`${apiUrl}/category/${id}`, {
        method: "DELETE",
        headers: {
    ...
    <div className="container my-4">
      ...
      <div>
        {categories.map((category) => (
          <div key={category._id} className="flex items-center justify-between rounded-md bg-white p-2 mb-2">
            ...
            <div className="flex items-center justify-end gap-3">
              ...
              <button
                onClick={() =>
                  router.push(`/admin/manageElement/showElement/${category._id}/category`)
                }
